  ...
  plot(dX,dy, pch=19, cex=1, col = "red", asp=1,xlab="X", ylab="Y", main="Diagrama ")
  ...
  points(DatosX,DatosY, pch=19, cex=1, col = "blue", asp=1,xlab="X", ylab="Y", main="Mano derecha")
  curve(PolinomioLagrance,add=T,from = 14.3,to = x[5])
  points(DatosX1,DatosY1, pch=19, cex=1, col = "blue", asp=1,xlab="X", ylab="Y", main="Mano derecha")
  curve(PolinomioLagrance1,add=T,from = x[5],to = x[9])
  points(DatosX2,DatosY2, pch=19, cex=1, col = "blue", asp=1,xlab="X", ylab="Y", main="Mano derecha")
  curve(PolinomioLagrance2,add=T,from = x[9],to = x[12],col="blue")
  points(DatosX3,DatosY3, pch=19, cex=1, col = "blue", asp=1,xlab="X", ylab="Y", main="Mano derecha")
  curve(PolinomioLagrance3,add=T,from = x[12],to = x[15])
  points(DatosX4,DatosY4, pch=19, cex=1, col = "blue", asp=1,xlab="X", ylab="Y", main="Mano derecha")
  curve(PolinomioLagrance4,add=T,from = x[15],to = x[18])
  points(DatosX5,DatosY5, pch=19, cex=1, col = "blue", asp=1,xlab="X", ylab="Y", main="Mano derecha")
  curve(PolinomioLagrance5,add=T,from = x[18],to = x[27])
  points(DatosX6,DatosY6, pch=19, cex=1, col = "blue", asp=1,xlab="X", ylab="Y", main="Mano derecha")
  curve(PolinomioLagrance6,add=T,from = x[27],to = x[30])
  points(DatosX7,DatosY7, pch=19, cex=1, col = "blue", asp=1,xlab="X", ylab="Y", main="Mano derecha")
  curve(PolinomioLagrance7,add=T,from = x[30],to = x[40])
  points(DatosX8,DatosY8, pch=19, cex=1, col = "blue", asp=1,xlab="X", ylab="Y", main="Mano derecha")
  curve(PolinomioLagrance8,add=T,from = x[37],to = x[40])
  points(DatosX9,DatosY9, pch=19, cex=1, col = "blue", asp=1,xlab="X", ylab="Y", main="Mano derecha")
  curve(PolinomioLagrance9,add=T,from = x[40],to = x[45])
  points(DatosX10,DatosY10, pch=19, cex=1, col = "blue", asp=1,xlab="X", ylab="Y", main="Mano derecha")
  curve(PolinomioLagrance10,add=T,from = x[45],to = x[50])
  points(DatosX11,DatosY11, pch=19, cex=1, col = "blue", asp=1,xlab="X", ylab="Y", main="Mano derecha")
  curve(PolinomioLagrance11,add=T,from = x[50],to = x[58])
  points(DatosX12,DatosY12, pch=19, cex=1, col = "blue", asp=1,xlab="X", ylab="Y", main="Mano derecha")
